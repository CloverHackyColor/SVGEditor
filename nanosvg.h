...
#define XString8 std::string
#define XString16 std::u16string  
#define XStringW std::wstring
#define XImage QImage
...
#define IsAlfa(x) (((x >= 'a') && (x <= 'z')) || ((x >= 'A') && (x <= 'Z')))
#define IsAscii(x) ((x >= 0x20) && (x <= 0x7F))
